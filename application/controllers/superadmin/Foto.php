...
class Foto extends CI_Controller
{
  function __construct()
  {
    ...
    // elseif($this->ion_auth->is_user()){redirect('superadmin/auth/login', 'refresh');}
  }
  ...
  public function create()
  {
    ...
    $this->data['action']         = site_url('superadmin/'.strtolower($this->data['module']).'/create_action');
      ...
      if ($_FILES['foto']['error'] <> 4)
      {
        ...
        if (!$this->upload->do_upload('foto'))
        {
          ...
          else
          {
            ...
            redirect(site_url('superadmin/foto'));
          }
      }
  ...
  public function update($id)
  {
    ...
    if($this->data['foto'])
    {
      ...
      $this->data['action']         = site_url('superadmin/foto/update_action');
      $this->data['button_submit']  = 'Simpan';
      $this->data['button_reset']   = 'Reset';
