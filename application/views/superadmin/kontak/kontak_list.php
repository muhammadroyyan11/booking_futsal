      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <div class="box-body">
								<a href="<?php echo base_url('admin/kontak/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
								<hr>
                      ...
                      <?php $no=1; foreach($get_all as $data){ ?>
                        <tr>
                          ...
                          <td style="text-align: center">
                            ...
                            echo anchor(site_url('admin/kontak/delete/'.$data->id_kontak),'<i class="fa fa-remove"></i>','title="Hapus", class="btn btn-sm btn-danger", onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"');
                            ?>
                          </td>
                        </tr>
                      <?php } ?>
