        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group"><label>Nama Album</label>
                    <?php echo form_dropdown('',$ambil_album,$foto->album_id,$album_id);?>
                  </div>
                  <div class="form-group"><label>Nama Foto</label>
                    <?php echo form_input($nama_foto, $foto->nama_foto);?>
                  </div>
                  <div class="form-group"><label>Foto Sebelumnya</label><br>
                    <img src="<?php echo base_url('assets/images/foto/'.$foto->foto.'') ?>" width="300px" class="img-responsive"/>
                  </div>
                  ...
                  <?php echo form_input($id_foto,$foto->id_foto);?>
