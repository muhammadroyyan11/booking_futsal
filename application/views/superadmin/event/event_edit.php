          ...
          <div class="col-lg-12">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group"><label>Nama <?php echo $module ?></label>
                    <?php echo form_input($nama_event, $event->nama_event);?>
                  </div>
                  <div class="form-group"><label>Deskripsi</label>
                    <?php echo form_textarea($deskripsi, $event->deskripsi);?>
                  </div>
                  <div class="form-group"><label>Nama Kategori</label>
										<?php echo form_dropdown('',$ambil_kategori,$event->kategori,$kat_id);?>
									</div>
                  <div class="form-group"><label>Foto Sebelumnya</label><br>
                    <img src="<?php echo base_url('assets/images/event/'.$event->foto.$event->foto_type.'') ?>" width="200px"/>
                  </div>
                  ...
                  <?php echo form_input($id_event,$event->id_event);?>
