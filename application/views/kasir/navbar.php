<header class="main-header">
  <a href="<?php echo base_url('kasir/dashboard') ?>" class="logo">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-body">
              <div class="col-xs-6 text-center">
                <a href='<?php $user_id = $this->session->userdata('user_id'); echo base_url('kasir/auth/edit_user/'.$user_id.'') ?>' class='btn btn-default btn-flat'>Edit Profil</a>
              </div>
              <div class="col-xs-6 text-center">
                <a href='<?php echo base_url() ?>kasir/auth/logout' class='btn btn-default btn-flat'>Logout</a>
              </div>
            </li>
          </ul>
        </li>
